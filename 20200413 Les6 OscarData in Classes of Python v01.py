...
class OscarFilm:            #Задание 6.1 Описать классами данные 
    ...
    budget, cost):
        ...
        self.key = (namefilm, year, budget)
                            # Задание 6.1 Конец
    def __repr__(self):
        return "OscarFilm('%s',%s,%s)" % (self.namefilm, self.year, self.budget)
    ...
    def filter_suspense(self):
        if 'история' in self.genre or 'фантастика' in self.genre:
            ...
            print ("Истории или фантастики нет в " +self.namefilm)
                            # Задание 6.2 Конец
                            # Задание 6.3 Реализовать нечеткий поиск. Бюджет картины около 20
...
WaterForm = OscarFilm("Форма воды", 2017, 6.914, 123, ['фантастика', 'драма'], 19.4, 195.243464)
MoonLight = OscarFilm("Лунный свет", 2016, 6.151, 110, ['драма'], 1.5, 65.046687)
AttentionCentre = OscarFilm("В центре внимания", 2015, 7.489, 129, ['драма', 'криминал', 'история'], 20.0, 88.346473)
Birdman = OscarFilm("Бёрдмэн", 2014, 7.604, 119, ['драма', 'комедия'], 18.0, 103.215094)
TwentyYearsSlave = OscarFilm("12 лет рабства", 2013, 7.71, 133, ['драма', 'биография', 'история'], 20.0, 178.371993)
